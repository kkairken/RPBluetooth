#!/usr/bin/env python3
"""
GhostFaceNets static quantization utilities.
Uses InsightFace quantization core but with GhostFaceNets preprocessing defaults.
"""
...
def prepare_calibration_data(
    ...
    for idx in tqdm(indices, desc="Preprocessing"):
        ...
        # GhostFaceNets expects BGR input
